...
Identity and access control who can enter the Audit UI and which organization, application, case, report, transaction, and activity-log data they can access.
